...
function Setup({d,onChanged}:{d:Detail;onChanged:()=>void}){
 ...
 const [v,setV]=useState<Record<string,unknown>>(()=>Object.fromEntries([...SETUP_FIELDS.map(([k])=>[k,p[k]??'']),['projectManagerUserId',p.projectManagerUserId||'']]));
